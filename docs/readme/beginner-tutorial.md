...
- 左侧用于切换数据表，也可以通过“+ 上传”导入自己的 Excel、CSV、TSV、JSON、XML 或 Parquet。
...
创建“空白项目”，进入“数据”页后点击“+ 上传”，选择 Excel / CSV / TSV / JSON / XML / Parquet 文件。导入完成后勾选字段并使用“发送到表单”或模板生成入口。更简短的操作清单见[使用自己的数据快速上手](./getting-started.md#使用自己的数据快速上手)。
