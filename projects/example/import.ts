// projects/example 示例项目导入说明
// 在浏览器控制台或通过项目管理界面导入 project.json
//
// 使用方式：
// 1. 打开 FormFlow Studio
// 2. 点击"导入项目"按钮
// 3. 选择 projects/example/project.json 文件
//
// 或在代码中调用：
//   import { importProjectFile } from '../../ui/src/project/manager';
//   const file = new File([await fetch('/projects/example/project.json').then(r => r.blob())], 'project.json');
