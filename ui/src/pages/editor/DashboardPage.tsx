...
export function DashboardPage() {
  ...
  useEffect(() => { if (project?.config.id) try { localStorage.setItem(storageKey, JSON.stringify({ widgets, layout })); } catch { /* ignore */ } }, [storageKey, widgets, layout, project?.config.id]);
