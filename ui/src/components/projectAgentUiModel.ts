...
export interface ProjectAgentActionStep { id: string; turnId?: string; index: number; status: 'deciding' | 'running' | 'completed' | 'waiting' | 'failed'; action?: 'assign' | 'complete' | 'ask_user' | 'abort'; summary?: string; progressed?: boolean; taskIds: string[]; observationIds: string[]; startedAt: string; completedAt?: string; }
